        ...
        <div id="inSidebar">
            <div id="blurLayout">
                ...
                <div class="link con" id="linkCon">
                    <div class="link item div active" onclick="scrollerFunction('mainBG')">
                        <div class="conted">
                    ...
                    <div class="link item div" onclick="scrollerFunction('edm')">
                        <div class="conted">
                            <img src="edm.png"/>
                            <span>EDM</span>
                        </div>
                    </div>
                    <div class="link item div" onclick="scrollerFunction('gallery')">
                        <div class="conted"><img src="gal.png"/><span>Gallery</span></div>
                    </div>
                    <div class="link item div" onclick="scrollerFunction('event')">
                        <div class="conted"><img src="event.png"/><span>Event</span></div>
                    </div>
                    <div class="link item div" onclick="scrollerFunction('shed')">
                        <div class="conted"><img src="shed.png"/><span>Schedule</span></div>
                    </div>
                    <div class="link item div" onclick="scrollerFunction('about')">
